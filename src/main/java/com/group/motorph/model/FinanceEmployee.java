...
/**
 * FinanceEmployee - Finance department employee
 */
public class FinanceEmployee extends Employee {
    ...
    public FinanceEmployee(String employeeId, String lastName, String firstName, LocalDate birthday, String address,
