 ...
 * Users can input numbers without dashes; this class auto-formats them.
 */
public class InputValidationUtil {

    // Employee ID: numeric 4-6 digits matching the employee-data.tsv format (e.g., 10001)
    ...
    // PAG-IBIG: 4-4-4 (e.g., 6912-9533-0870)
    private static final Pattern PAGIBIG_PATTERN = Pattern.compile("\\d{4}-\\d{4}-\\d{4}");
    // PHILHEALTH: 12 raw digits (no dashes, matching existing CSV/TSV format)
